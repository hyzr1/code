...
test("the courses page offers Python, DSA, and machine learning", async ({ page }) => {
  ...
  expect(await page.locator(".course-module").count()).toBeGreaterThan(0);
...
test("the course selector fills every responsive layout without overflow", async ({ page }, testInfo) => {
