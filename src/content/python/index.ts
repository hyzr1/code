...
const ORDER_WITHIN_MODULE: Record<string, string[]> = {
  ...
  "py.m1": ["booleans", "branching", "lists", "loops", "iteration-tools", "aggregation-tools", "names", "functions"],
  "py.m2": ["tuples", "dicts", "sets", "comprehensions", "sorting", "complexity"],
  "py.m3": ["imports", "arguments", "scope", "exceptions", "decorators"],
